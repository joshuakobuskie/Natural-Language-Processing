...
def generate_markdown_from_history(history):
    ...
    with open("context_details.md", "w") as f3:
...
def main():
    while True:
        ...
        #Toggle based on context for only one value
        #Pass the answer to the front end and dont look back
        #John will do whatever for analysis
